...
<div style="border: 1px solid #d0d0d0; border-left: 4px solid #2563eb;
            background: #f7f9fc; padding: 12px 16px; border-radius: 6px;">
  <strong>La méthodo' en bref</strong><br>
  475 ostéopathes diplômés ont répondu à ce questionnaire en ligne, entre le 4 et le 28 novembre 2025, à tous les stades de carrière — des diplômés de moins de six mois aux praticiens installés depuis plus de dix ans.
...
[![Premier mode d'exercice post diplôme](./1-MODE-EXERCICE.png)](./1-MODE-EXERCICE.png)
...
[![Premier mode d'exercice post diplôme](./AUJ-MODE-EXERCICE.png)](./AUJ-MODE-EXERCICE.png)
...
[![Méthode de développement de la patienèle](./DVP.png)](./DVP.png)
...
[![Principale satisfaction professionnelle](./SATISFACTION.png)](./SATISFACTION.png)
...
[![Grands thèmes des défis rencontrés](./THEMES-DEFIS.png)](./THEMES-DEFIS.png)
...
[![Sentiment d'isolement dans la pratique quotidienne](./ISOLEMENT.png)](./ISOLEMENT.png)
...
[![Adéquation des revenus en fonction de l'ancienneté](./ANCIENNETE-REVENUS.png)](./ANCIENNETE-REVENUS.png)
...
[![Adéquation des revenus en fonction du mode d'exercice](./EXERCICE-REVENUS.png)](./EXERCICE-REVENUS.png)
...
[![Préparation clinique (sur 5)](./CLINIQUE.png)](./CLINIQUE.png)
...
[![Préparation entrepreneuriale (sur 5)](./ENTREPRENEUR.png)](./ENTREPRENEUR.png)
...
[![Thème des principaux défis](./DEFIS.png)](./DEFIS.png)
...
[![Taux de formation par rapport à l'ancienneté](./FORMATION.png)](./FORMATION.png)
...
[![Thèmes des formations](./THEMES-FORMATIONS.png)](./THEMES-FORMATIONS.png)
...
[![Vision de l'avenir de la profession](./AVENIR.png)](./AVENIR.png)
...
[![Thèmes des raisons de la vision de l'avenir](./RAISONS-AVENIR.png)](./RAISONS-AVENIR.png)
...
[![Répartition des motifs d'optimisme ou de pessimisme](./MOTIFS-VISION.png)](./MOTIFS-VISION.png)
...
[![Répartition du ton des conseils](./TON-CONSEILS.png)](./TON-CONSEILS.png)
...
[![Ton des conseils par rapport à l'ancienneté](./ANCIENNETE-CONSEILS.png)](./ANCIENNETE-CONSEILS.png)
